import {
    initialExperience,
    useGlobalCv,
  } from "../global-hooks/useGlobalTodos";
  import {
    TextField,
    Button,
    Typography,
    ...
    return (
      <Box maxWidth="md" className={className}>
        <Paper elevation={3} sx={{ padding: 3 }}>
            <Grid justifyContent="center" textAlign="center" item xs={12}>
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} justifyContent="center" textAlign="center" >
              <Typography variant="h6" marginBottom={2}>Experience</Typography>
              {cvData.experience.map((experience, index) => (
                <Experience key={index} index={index} experience={experience} />
              ))}
  
              <Grid item xs={12} justifyContent="center" textAlign="center" marginTop={2}>
